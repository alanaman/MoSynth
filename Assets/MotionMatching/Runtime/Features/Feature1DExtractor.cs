...
{
    public abstract class Feature1DExtractor : ScriptableObject
    {
        /// <summary>
        ...
        /// </summary
        public abstract float ExtractFeature(PoseBuffer pose, int poseIndex, PoseBuffer nextPose, int animationClip, SkeletonAsset skeleton, float3 characterOrigin, float3 characterForward);
        /// <summary>
