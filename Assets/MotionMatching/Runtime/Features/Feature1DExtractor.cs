...
namespace MotionMatching
{
    public abstract class Feature1DExtractor : ScriptableObject
    {
        ...
        /// </summary
        public abstract float ExtractFeature(PoseVector pose, int poseIndex, PoseVector nextPose, int animationClip, SkeletonAsset skeleton, float3 characterOrigin, float3 characterForward);
        /// <summary>
