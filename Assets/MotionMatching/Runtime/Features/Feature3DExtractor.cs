...
namespace MotionMatching
{
    public abstract class Feature3DExtractor : ScriptableObject
    {
        ...
        /// </summary
        public abstract float3 ExtractFeature(PoseVector pose, int poseIndex, PoseVector nextPose, int animationClip, SkeletonAsset skeleton, float3 characterOrigin, float3 characterForward);
        /// <summary>
