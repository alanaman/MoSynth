...
namespace MotionMatching
{
    public abstract class Feature2DExtractor : ScriptableObject
    {
        ...
        /// </summary
        public abstract float2 ExtractFeature(PoseVector pose, int poseIndex, PoseVector nextPose, int animationClip, SkeletonAsset skeleton, float3 characterOrigin, float3 characterForward);
        /// <summary>
