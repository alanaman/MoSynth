...
namespace MotionMatching
{
    public abstract class Feature2DExtractor : ScriptableObject
    {
        ...
        /// </summary
        public abstract float2 ExtractFeature(PoseBuffer pose, int poseIndex, PoseBuffer nextPose, int animationClip, SkeletonAsset skeleton, float3 characterOrigin, float3 characterForward);
        /// <summary>
